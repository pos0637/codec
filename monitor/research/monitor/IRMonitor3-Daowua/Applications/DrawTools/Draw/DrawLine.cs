...
namespace DrawTools
{
    ...
    public class DrawLine : DrawObject
    {
        ...
        public override void Draw(Graphics g, Rectangle boundary, Single xScale, Single yScale, Pen pen)
        {
            ...
            start.X = (Int32)(startPoint.X * xScale + boundary.X);
            start.Y = (Int32)(startPoint.Y * yScale + boundary.Y);

            end.X = (Int32)(endPoint.X * xScale + boundary.X);
            end.Y = (Int32)(endPoint.Y * yScale + boundary.Y);
