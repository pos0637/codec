    ...
    public class CHCNetSDK
    {
        ...
        **************************************************/
        ...
        public struct NET_DVR_XML_CONFIG_INPUT
        {
            public uint dwSize;                        //结构体大小
            [MarshalAsAttribute(UnmanagedType.LPStr)]
            public string lpRequestUrl;                //请求信令，字符串格式
            public uint dwRequestUrlLen;            //请求信令长度，字符串长度
            [MarshalAsAttribute(UnmanagedType.LPStr)]
            public string lpInBuffer;                    //输入参数缓冲区，XML格式
        ...
        public struct NET_DVR_FOCUSMODE_CFG
        {
            ...
            public int wMinFocusDistance; /* 最小聚焦距离，单位CM,  0-自动，0xffff-无穷远 */
        ...
        {
            public uint u32RTDataType; // 1-14bit裸数据; 2-全屏测温结果数据; 3-YUV数据
            public uint u32FrmNum;
            public uint u32StdStamp; // DSP相对时间戳
        ...
        public struct STREAM_FRAME_INFO_S
        {
            public uint u32MagicNo; // 0x70827773 "FRMI"的ascll码
            public uint u32HeaderSize; // 结构体长度
            public uint u32StreamType; // 数据类型： h264/h265, JPEG, Audio, MetaData, RTData: 参见 STREAM_TYPE_E
            public uint u32StreamLen; // 数据长度
        ...
        ******************************************************************************/
...
#else
        [DllImportAttribute("HCNetSDK.so")]
#endif
        ...
        [DllImportAttribute("HCNetSDK.so")]
#endif
        public static extern bool NET_DVR_GetDVRConfig(int lUserID, uint dwCommand, int lChannel, string lpOutBuffer, uint dwOutBufferSize, ref uint lpBytesReturned);
        ...
        [DllImportAttribute("HCNetSDK.so")]
#endif
        public static extern bool NET_DVR_SetDVRConfig(int lUserID, uint dwCommand, int lChannel, string lpInBuffer, uint dwInBufferSize);
