    ...
    public class DrawRectangle : DrawObject
    {
        ...
        public override Point GetHandle(int handleNumber)
        {
            ...
            if (Rotation != 0) {
                ...
                foreach (PointF point in gp.PathPoints) {
                    points[i++] = new Point((Int32)point.X, (Int32)point.Y);
                }
                gp.Dispose();
            }
            else {
        ...
        public override GraphicsData GetGraphicsData()
        {
            ...
            if (Rotation != 0) {
                ...
                data.PointList.Add(Point.Truncate(gp.PathPoints[0]));
                data.PointList.Add(Point.Truncate(gp.PathPoints[1]));
                data.PointList.Add(Point.Truncate(gp.PathPoints[2]));
                data.PointList.Add(Point.Truncate(gp.PathPoints[3]));
                gp.Dispose();
            }
            else {
                data.PointList.Add(new Point(rectangle.Left, rectangle.Top));
                data.PointList.Add(new Point(rectangle.Right, rectangle.Top));
                data.PointList.Add(new Point(rectangle.Right, rectangle.Bottom));
                data.PointList.Add(new Point(rectangle.Left, rectangle.Bottom));
            }
