...
namespace DrawTools
{
    ...
    public partial class DrawArea : UserControl
    {
        ...
        private System.Drawing.Size mResolution = new System.Drawing.Size();
        private Rectangle mBoundary = new Rectangle();
        private Rectangle mOrignBoundary = new Rectangle();
        private System.Drawing.Point mLeftTopPoint = new System.Drawing.Point();
        private System.Drawing.Size mSize = new System.Drawing.Size();
        ...
        public void Initialize(Form formOwner, DrawToolbar drawToolbar, System.Drawing.Size resolution)
        {
            if (mBitmap != null)
                return;
            ...
            lock (this) {
                ...
                if (_layers != null) {
                    ...
                    for (int i = 0; i < lc; i++) {
                        if (_layers[i].IsVisible) {
                            if (_layers[i].Graphics != null)
                                _layers[i].Graphics.Remove(mDrawToolbar.DrawArea);
                        }
                    }
                }
        ...
        internal System.Drawing.Point BackTrackMouse(System.Drawing.Point p)
        {
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void DrawArea_Rectangle(object sender, PaintEventArgs e)
        {
            RenderView(e.Graphics);
        }
        ...
        private void DrawArea_MouseMove(object sender, MouseEventArgs e)
        {
            ...
            System.Drawing.Point curLoc = this.ConvertPoint(e.Location);
        ...
        private void DrawArea_MouseUp(object sender, MouseEventArgs e)
        {
            ...
            System.Drawing.Point p = this.ConvertPoint(e.Location);
        ...
        private void DrawArea_Move(object sender, EventArgs e)
        {
            ...
            System.Drawing.Point point = this.ConvertPoint(ClientRectangle.Location);
        ...
        private void RenderView(Graphics g)
        {
            ...
            Color color;
            if (mDrawToolbar.DrawArea.CurrentPen == null) {
                color = Color.Red;
            }
            else {
                color = mDrawToolbar.DrawArea.CurrentPen.Color;
            }
            ...
            if (_layers != null) {
                ...
                for (int i = 0; i < lc; i++) {
                    if (_layers[i].IsVisible) {
                        if (_layers[i].Graphics != null)
                            _layers[i].Graphics.Draw(g, boundary, mScaleX, mScaleY, color, mDrawToolbar.DrawArea.LineWidth);
                    }
                }
            }
        ...
        public Bitmap GetBitmap()
        {
            ...
            try {
                lock (this) {
                    bmap = new Bitmap(mDrawToolbar.DrawArea.Width, mDrawToolbar.DrawArea.Height, PixelFormat.Format24bppRgb);
                    using (Graphics grap = Graphics.FromImage(bmap)) {
                        Rectangle boundary = mBoundary;
                        ...
                        if (_layers != null) {
                            ...
                            for (int i = 0; i < lc; i++) {
                                if (_layers[i].IsVisible) {
                                    if (_layers[i].Graphics != null)
                                        _layers[i].Graphics.Draw(grap, boundary, mScaleX, mScaleY, color, mDrawToolbar.DrawArea.LineWidth);
                                }
                            }
                        }
        ...
        /// 获取几何图形参数
        /// </summary>
        public List<List<System.Drawing.Point>> GetParameters()
        {
            lock (this) {
                List<GraphicsData> graphicsDataList = mDrawToolbar.DrawArea.GetGraphicsDataList();
                if ((graphicsDataList != null) && (graphicsDataList.Count > 0)) {
                    List<List<System.Drawing.Point>> contours = new List<List<System.Drawing.Point>>();
                    foreach (GraphicsData data in graphicsDataList) {
                        List<System.Drawing.Point> pts = new List<System.Drawing.Point>();
                        foreach (System.Drawing.Point point in data.PointList) {
                            pts.Add(new System.Drawing.Point(point.X, point.Y));
                        }
                        contours.Add(pts);
                    }
                    return contours;
        ...
        /// <param name="p"></param>
        /// <returns></returns>
        private System.Drawing.Point ConvertPoint(System.Drawing.Point p)
        {
            return p;
        }
        #endregion
